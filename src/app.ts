...
import { infinitePostsExample } from './examples/rx-dom/infinite-posts/9gag.example';
...
import { helloWorldExample } from './examples/rx-dom/hello-world-update/hello-world.example';
